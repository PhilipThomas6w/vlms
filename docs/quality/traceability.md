...
| BR-003 Safeguarding & consent | Annual consent, DBS, expiry blocking, guardian-link verification (`functional.md`) | `data-design.md` (ConsentRecord, DbsCheck, StudentGuardianLink), `low-level-design.md` (ConsentExpiryJob) | TC-002, TC-009, TC-012, TC-013 | Designed |
...
| NFR-001 Access control / PII | Role-based + resource-based authorization, DBS/consent masking, read audit log (`non-functional.md`, `governance/security-compliance.md`) | `low-level-design.md` (authorization model), `adr/0002`, `adr/0004` | TC-006, TC-007, TC-008, TC-011 | Designed |
