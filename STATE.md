...
## In progress
- Microsoft Entra External ID integration (`docs/adr/0001-technology-stack.md`), `AppUser`/`UserRole` provisioning, and the role- plus resource-based authorization policies from `docs/adr/0002-roles-as-application-claims.md` and `docs/design/low-level-design.md`.
